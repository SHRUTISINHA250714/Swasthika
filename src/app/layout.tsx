...
//   title: "Rehab",
//   description:
//     "Rehabilitation Platform for Physical Therapy, Mental Services, and more.",
// };
...
//   return (
//     <html lang="en">
//       <body className="bg-white text-black vsc-initialized">{children}</body>
//     </html>
//   );
// }
// "use client";
...
// import PatientDashboard from "./PatientDashboard/layout";
